...
class UserProfileControllerTest {
	...
	void getProfileByUserId_shouldReturnOk() {
		ProfileResponse profileResponse = new ProfileResponse(1L, 2L, "user@mail.com", "John", "Bio");
	...
	void updateProfileByUserId_shouldReturnOk() {
		...
		ProfileResponse profileResponse = new ProfileResponse(1L, 2L, "user@mail.com", "Jane", "New bio");
